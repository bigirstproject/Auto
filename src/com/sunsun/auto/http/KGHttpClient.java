...
import com.sunsun.auto.AppException;
import com.sunsun.auto.AutoApplication;
import com.sunsun.auto.logcat.KGLog;
...
public class KGHttpClient {
	...
	private static HttpClient createHttpClient(RequestPackage requestPackage) {
		...
		// cmwap设置代理
		boolean isCmwap = NetWorkUtil.isCmwap(AutoApplication.getInstance());
		if (isCmwap) {
	...
	public static String getUserAgent() {
		if (TextUtils.isEmpty(sUserAgent)) {
			PackageInfo pi = AutoApplication.getInstance().getPackageInfo();
