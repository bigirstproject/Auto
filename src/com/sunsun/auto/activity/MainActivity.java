package com.sunsun.auto.activity;
...
import com.sunsun.auto.adapter.ViewPagerAdapter;
import com.sunsun.auto.fragment.ChannelFragment;
import com.sunsun.auto.fragment.GalleryFragment;
import com.sunsun.auto.fragment.NewsFragment;
import com.sunsun.auto.fragment.VideoFragment;
import com.sunsun.auto.ui.widget.ScrollableViewPager;
import com.sunsun.auto.ui.widget.TitleBarView;
import com.sunsun.auto.util.ToastUtil;
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK
			...
			if ((System.currentTimeMillis() - exitTime) > 2000) {
				ToastUtil.makeText(getApplicationContext(), "再按一次退出程序").show();
