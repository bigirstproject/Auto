package com.sunsun.auto.logcat;
...
import com.sunsun.auto.config.AppConfig;
import com.sunsun.auto.helper.StoragePathHelper;
import com.sunsun.auto.util.DateUtil;
...
public class ExceptionLogger {
	...
	public static void logCrash(String crashInfo) {
		try {
			...
			jsonObj.put("version", AutoApplication.getInstance()
					.getAppVersion());
			jsonObj.put("device", Secure.getString(AutoApplication
